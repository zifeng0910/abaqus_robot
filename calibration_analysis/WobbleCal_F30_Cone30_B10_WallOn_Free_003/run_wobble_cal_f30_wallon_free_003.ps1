[CmdletBinding()]
param([string]$WorkDir='J:\abaqusfangzhen',[string]$JobName='WobbleCal_F30_Cone30_B10_WallOn_Free_003',[int]$Port=65495)
...
Write-Host "Starting analytic field server: F=30 Hz, B=10 mT, gradient=3 mT=0.003 T, WALL-ON, free translation, port $Port"
