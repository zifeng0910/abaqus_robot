...
C Live production socket bridge for the 0.5 ms magnetic A/B only.
C FLUID_MODE=NONE: any HYDRO_* amplitudes are deliberately returned as zero.
C=======================================================================
    ...
    5 CONTINUE
      ...
      IF (initialized.EQ.0) THEN
         lastTime=-1.0D99; connected=0; failCount=0
         DO 10 idx=1,6
            loads(idx)=0.0D0
   10    CONTINUE
         initialized=1
      ...
      IF (isMaster.EQ.1 .AND.ABS(tSend-lastTime).GT.1.0D-15) THEN
