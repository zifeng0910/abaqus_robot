...
C Reduced-Hydro VUAMP bridge with prescribed background flow.
...
C        Rodrigues rotation of initial body axis by Abaqus UR vector.
     ...
     *           (cc+kz*kz*(1.0D0-cc))*a0(3)
         ...
         IF (logInit.EQ.0) THEN
            OPEN(77,FILE='J:\\abaqusfangzhen\\abaqus_robot\\calibration_analysis\\F40LowG'//
     *           'BackgroundFlowScreen\\case\\S4_HEADFORWARD_F40_G0P05_FLOW\\'//
