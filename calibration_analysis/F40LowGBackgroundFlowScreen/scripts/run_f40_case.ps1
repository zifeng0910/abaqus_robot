...
$out = Join-Path $repo 'calibration_analysis\F40LowGBackgroundFlowScreen'
$case = Join-Path $out 'case\S4_HEADFORWARD_F40_G0P05_FLOW'
...
$arguments = @('-u',$server,'--host','127.0.0.1','--port',"$Port",'--job-name',$job,
    ...
    '--analytic-b-t','0.010','--analytic-follow-robot','--analytic-gradient-b-t','0.00005',
