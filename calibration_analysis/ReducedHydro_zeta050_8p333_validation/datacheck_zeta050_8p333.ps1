...
$job='Wobble_F30_G6L45_ReducedHydro_Zeta050_WallOn_Free_0083_Datacheck'
$input='Wobble_F30_G6L45_ReducedHydro_Zeta050_WallOn_Free_0083.inp'
...
Write-Host 'DATACHECK PASS: frozen zeta=0.50 8.333 ms deck accepted by Abaqus 2025'
