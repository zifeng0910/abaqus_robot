[CmdletBinding()]
param([string]$WorkDir='J:\abaqusfangzhen',[int]$Port=65508)
...
Write-Host 'FROZEN VALIDATION: Reduced-Hydro, zeta=0.50, tangent=0, SmoothWall114; no parameter tuning.'
Write-Host 'FIELD: B0=10mT, f=30Hz, cone=30deg, Bias=40deg, G=6mT, L=45mm, phase=248deg, sense=+1'
Write-Host "TRAJECTORY_DIRECTION=FORWARD; PORT=$Port; DIRECT_DT=0.1us; duration=8.333ms; CONTACT_HISTORY=every_increment; FIELD=25us"
