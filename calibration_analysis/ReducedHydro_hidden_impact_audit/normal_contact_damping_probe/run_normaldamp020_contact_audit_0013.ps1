[CmdletBinding()]
param([string]$WorkDir='J:\abaqusfangzhen',[int]$Port=65506)
...
Write-Host "TRAJECTORY_DIRECTION=FORWARD; PORT=$Port; NORMAL_DAMPING=0.20; TANGENT_FRACTION=0.0; DIRECT_DT=0.1us; duration=1.3ms; CONTACT_HISTORY=every_increment; FIELD=0.5us"
