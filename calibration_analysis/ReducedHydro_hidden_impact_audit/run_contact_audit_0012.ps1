[CmdletBinding()]
param([string]$WorkDir='J:\abaqusfangzhen',[int]$Port=65505)
...
Write-Host "TRAJECTORY_DIRECTION=FORWARD; PORT=$Port; DIRECT_DT=0.1us; duration=1.3ms; CONTACT_HISTORY=every_increment; FIELD=0.5us"
