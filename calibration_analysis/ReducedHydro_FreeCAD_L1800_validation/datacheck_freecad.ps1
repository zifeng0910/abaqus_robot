...
$job='Wobble_F30_G6L45_ReducedHydro_Zeta050_CAD_L1800_D0815_WallOn_Free_0083_Datacheck'
$input='Wobble_F30_G6L45_ReducedHydro_Zeta050_CAD_L1800_D0815_WallOn_Free_0083.inp'
...
Write-Host 'DATACHECK PASS: exact FreeCAD STEP robot'
