...
contains
  ...
  subroutine open_increment_log()
    if (log_open) return
    open(unit=77,file='J:\abaqusfangzhen\abaqus_robot\calibration_analysis\FastVMean5Calibration\case\FAST_PRECOMP_F120_VMEAN5_SELECTED\magnetic_hydro_increment.csv',status='replace')
