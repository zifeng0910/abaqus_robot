...
def main():
    ...
    if model.drive_type == 'analytic':
        print('ANALYTIC_ROTATING_FIELD: B=%.9g T; f=%.9g Hz; cone=%.9g deg; bias=%.9g deg; frame_azimuth=%.9g deg; gradient_B=%.9g T; gradient_L=%.9g mm; grad_tilt=%.9g deg; grad_azimuth=%.9g deg; sense=%+.0f; basis=%s' %
