[CmdletBinding()]
param([string]$WorkDir='J:\abaqusfangzhen',[int]$Port=65499)
$ErrorActionPreference='Stop'; Set-Location -LiteralPath $WorkDir
$JobName='Wobble_F30_ConeFrameAzimuth_Chi134_WallOn_Free_003'
...
Write-Host "chi=134 deg cone-frame azimuth 3 ms probe finished. Telemetry: $telemetry"
