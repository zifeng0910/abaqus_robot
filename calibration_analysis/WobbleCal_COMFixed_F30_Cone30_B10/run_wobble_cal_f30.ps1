[CmdletBinding()]
param([string]$WorkDir='J:\abaqusfangzhen',[string]$JobName='WobbleCal_COMFixed_F30_Cone30_B10',[int]$Port=65492)
...
Write-Host "Starting analytic field server: F=30 Hz, B=10 mT, gradient=3 mT=0.003 T, COM-fixed, port $Port"
